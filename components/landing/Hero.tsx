      ...
      <div className="relative z-10 mx-auto max-w-[760px] text-center">
        ...
        <div data-hero-actions className="flex flex-col items-center justify-center gap-3 sm:flex-row">
          ...
          <TrackedLink
            ...
            className="w-full rounded-md bg-white/70 px-7 py-3.5 text-sm font-semibold tracking-wide text-forest ring-1 ring-brass/50 transition-colors hover:bg-white sm:w-auto"
          >
            Start your plan
          </TrackedLink>
        </div>
          ...
          {["7-day free trial", "Cancel anytime", "No account needed to try"].map((item) => (
            <li key={item} className="flex items-center gap-1.5">
              <svg width="12" height="12" viewBox="0 0 12 12" aria-hidden="true">
                <path d="M2.5 6.2 5 8.5l4.5-5" fill="none" stroke="#a8834b" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
              {item}
            </li>
          ))}
        ...
        <a
          href="#parents"
          className="mt-6 inline-flex items-center gap-2 rounded-full bg-white/70 px-4 py-2 text-[13px] text-stone-600 ring-1 ring-brass/40 transition-colors hover:text-forest hover:ring-brass/70"
        >
          <span className="rounded-full bg-forest px-2 py-0.5 text-[10px] font-semibold uppercase tracking-[0.14em] text-brass-light">Parents</span>
