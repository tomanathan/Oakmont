...
// and button render at full opacity immediately. The bottom padding doubles
// as the floor the pets play on.
export function Hero() {
  return (
    <section className="relative overflow-hidden px-6 pt-20 pb-20 sm:pt-28 sm:pb-28">
      <HeroPets />
      <div className="relative z-10 max-w-[720px] mx-auto text-center">
        ...
        <div data-hero-actions className="flex flex-col sm:flex-row items-center justify-center gap-3">
          <TrackedLink
            href="#try-a-question"
