// "Continue with Google", shared by the student and parent login pages.
// A plain link (a full page navigation), since the flow leaves the site for
// Google's account chooser -- see app/api/auth/google.
export function GoogleButton({ href, onClick }: { href: string; onClick?: () => void }) {
  return (
    <a
      href={href}
      onClick={onClick}
